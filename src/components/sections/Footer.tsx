        ...
        <div className="border-t border-amber-500/20 pt-12">
          <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-3 text-slate-700">
                <a href="https://www.linkedin.com" aria-label="LinkedIn" className="rounded-full border border-brand-yellow/30 bg-white/90 p-2 shadow-glass transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-yellow/50 hover:text-brand-neutral-900 hover:shadow-glass-hover">
                  <Linkedin className="h-4 w-4" />
                </a>
                <a href="https://www.instagram.com" aria-label="Instagram" className="rounded-full border border-brand-yellow/30 bg-white/90 p-2 shadow-glass transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-yellow/50 hover:text-brand-neutral-900 hover:shadow-glass-hover">
                  <Instagram className="h-4 w-4" />
                </a>
                <a href="https://www.facebook.com" aria-label="Facebook" className="rounded-full border border-brand-yellow/30 bg-white/90 p-2 shadow-glass transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-yellow/50 hover:text-brand-neutral-900 hover:shadow-glass-hover">
                  <Facebook className="h-4 w-4" />
                </a>
                <a href="mailto:hello@feecollect.io" aria-label="Email us" className="rounded-full border border-brand-yellow/30 bg-white/90 p-2 shadow-glass transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-yellow/50 hover:text-brand-neutral-900 hover:shadow-glass-hover">
          ...
          <div className="mt-12 flex flex-col gap-4 border-t border-amber-500/20 pt-5 text-slate-700 font-medium md:flex-row md:items-center md:justify-between">
            <div className="flex flex-wrap items-center gap-3 text-sm">
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-50/90 px-2.5 py-1 font-semibold text-emerald-900 shadow-glass">
